...
function Signup() {
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-[85vh] px-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="w-full max-w-md">
                <div className="glass p-8 md:p-10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-slate-400">Join the next generation of chess analysis</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-slate-500 px-1 italic">Must be at least 6 characters long</p>
                        </div>

                        <button
                            type="submit"
                            disabled={loading}
                            className="btn-primary w-full py-4 text-lg mt-6 group"
                        >
                    ...
                    <div className="mt-10 pt-8 border-t border-white/5 text-center">
                        <p className="text-slate-400">
                            Already have an account? <Link to="/login" className="text-indigo-400 hover:text-indigo-300 transition-colors font-black">Sign In Instead</Link>
                        </p>
                    </div>
                </div>
            </div>
